        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>Ao lado você pode inserir diferentes jogos, categorias e publishers para a nossa incrível loja de jogos!</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de dúvidas e ou sugestôes, só ir em algum de nosso links =)</P>
              <ALink
